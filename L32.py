...
cactus_sprites = [pygame.image.load("pic/LargeCactus1.png"),
                  pygame.image.load("pic/LargeCactus2.png"),
                  pygame.image.load("pic/LargeCactus3.png"),
                  pygame.image.load("pic/SmallCactus1.png"),
                  pygame.image.load("pic/SmallCactus2.png"),
                  pygame.image.load("pic/SmallCactus3.png")]
c_sprite = 0
cactus_x = WIDTH
cactus_y = HEIGHT - 80
cactus_pic = cactus_sprites[random.randint(0, 5)]

basic_font = pygame.font.Font("fonts/base.ttf", 20)
text_end_game = basic_font.render(f"Конец игры", True, "white")
text_end_game_rect = text_end_game.get_rect(centerx=WIDTH/2, centery=HEIGHT/2)
...
def count_score():
    global score
    score += 1
    font = pygame.font.Font("fonts/base.ttf", 20)
